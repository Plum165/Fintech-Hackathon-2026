    ...
    <div className="space-y-4">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm space-y-3">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {/* Search */}
          <div className="sm:col-span-1 relative flex items-center bg-slate-50 border border-slate-200 focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500 rounded-xl px-3 py-2">
          ...
          {/* Type Filter */}
          <div className="flex items-center bg-slate-50 border border-slate-200 focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500 rounded-xl px-3 py-1">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs">
          ...
          <input
            ...
            className="bg-slate-50 border border-slate-200 text-[10px] text-slate-600 px-2 py-1 rounded-md focus:outline-none focus:border-indigo-500 font-mono font-medium"
          />
            ...
            >
              ...
              <div className="py-4 space-y-3 font-mono text-[11px] text-slate-600">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-indigo-600 font-bold">{selectedTx.category}</span>
                </div>
                <div className="flex justify-between">
