              ...
              <form onSubmit={handleAddCategory} className="space-y-4">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 text-xs text-slate-800 px-3.5 py-2.5 rounded-xl focus:outline-none focus:border-peach-500 focus:ring-1 focus:ring-peach-500 font-medium"
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 text-xs text-slate-800 px-3.5 py-2.5 rounded-xl focus:outline-none focus:border-peach-500 focus:ring-1 focus:ring-peach-500 font-mono font-bold"
                    placeholder="500.00"
                    required
                  />
                </div>
                    ...
                    {['#1D9E75', '#378ADD', '#A32D2D', '#EF9F27', '#854F0B'].map((col) => (
                      <button
                        ...
                        className={`h-7 rounded-lg transition-all ${
                          color === col ? 'ring-2 ring-peach-500 scale-105 shadow-md' : 'opacity-80 hover:opacity-100'
                        }`}
                      ></button>
                    ))}
                  </div>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full flex items-center justify-center gap-1.5 py-2.5 bg-peach-600 hover:bg-peach-700 disabled:bg-slate-100 text-white font-bold text-xs rounded-xl cursor-pointer shadow-sm"
                >
